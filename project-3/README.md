(Java) Huffman Coding Part 1: Implement the three steps of the Huffman coding scheme: compute frequency, construct ordered link-list, and construct Huffman binary tree.
